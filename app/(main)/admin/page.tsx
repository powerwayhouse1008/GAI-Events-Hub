...
export default async function AdminPage() {
  ...
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-10">
      <h1 className="text-5xl font-black tracking-tight">管理者</h1>
      <p className="mt-3 text-slate-500">イベント管理、アカウント権限、サイトリンクを管理できます。</p>

      <div className="mt-8 grid gap-5 md:grid-cols-2">
        <Link href="/admin/events" className="card p-7 hover:bg-purple-50">
          <p className="text-sm font-bold uppercase tracking-wide text-purple-600">イベント管理</p>
          <p className="mt-4 text-4xl font-black">{pendingEvents}</p>
          <p className="mt-2 text-slate-500">承認待ちを含むすべてのイベント</p>
        </Link>

        <Link href="/admin/accounts" className="card p-7 hover:bg-purple-50">
          <p className="text-sm font-bold uppercase tracking-wide text-purple-600">アカウント権限</p>
